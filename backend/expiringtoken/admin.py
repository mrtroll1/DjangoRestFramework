...
from .models import ExpiringToken, ExpiringTokenProxy

User = get_user_model()


class ExpiringTokenChangeList(ChangeList):
...
class ExpiringTokenAdmin(admin.ModelAdmin):
    ...
    def get_changelist(self, request, **kwargs):
        return ExpiringTokenChangeList
    ...
    def delete_model(self, request, obj):
        ...
        token = ExpiringToken.objects.get(key=obj.key)
        return super().delete_model(request, token)


admin.site.register(ExpiringTokenProxy, ExpiringTokenAdmin)
